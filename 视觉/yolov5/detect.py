        ...
        for i, det in enumerate(pred):  # per image
            ...
            if view_img:
                if platform.system() == 'Linux' and p not in windows:
                    ...
                    pre_frame = None
                    gray_lwpCV = cv2.cvtColor(im0, cv2.COLOR_BGR2GRAY)
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='yolov5/runs/train/exp3/weights/best.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default='1', help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--data', type=str, default='yolov5/data/day19.yaml', help='(optional) dataset.yaml path')
